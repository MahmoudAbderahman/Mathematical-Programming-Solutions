...
public class ZD_View extends JPanel implements ActionListener, PropertyChangeListener {
	...
	// Array of strings for the combobox choices
	...
	JTextField number_input = new JTextField("",35);
	JTextField number_output = new JTextField("",35);
	...
	private void readInput(){
		try {
			...
			if(!number_input.getText().matches("[a-fA-F0-9]+") || number_input.getText().equals(null))
			{
				throw new NumberFormatException("Sie haben nichts oder Flasches Eingabeformat eingegebene!");
			}
